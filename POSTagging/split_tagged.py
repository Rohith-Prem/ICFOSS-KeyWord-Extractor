...
def splitTagged():
    ...
    del lines[-3:]
    in_file.close()
    in_file = open("/home/rohith/ICFOSS-KeyWord-Extractor/POSTagging/tagged_text2.txt", "w", encoding="utf-8")
    in_file.writelines(lines)
    in_file.close()
    in_file = open("/home/rohith/ICFOSS-KeyWord-Extractor/POSTagging/tagged_text2.txt", "r", encoding="utf-8")
    inp = in_file.read()
    in_file.close()
